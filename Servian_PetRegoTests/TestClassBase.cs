...
namespace PetRegoTests
{
    public abstract class TestClassBase<T> where T : class
    {
        ...
        //Each table has it's own function to make it easier to test against.
        protected IEnumerable<LkpAnimalType> GenerateLkpAnimalTypes()
        {
            return new List<LkpAnimalType>
            {
        ...
        protected IEnumerable<tblOwner> GenerateTblOwners()
        {
            return new List<tblOwner>
            {
        ...
        protected IEnumerable<tblPet> GenerateTblPets()
        {
            return new List<tblPet>
            {
